...
download.file(fileUrl,
  destfile = here("static", "site_libs", "bib", "publicationsCVclean.bib"),
  method = "curl")

# Load bib
bib <- ReadBib(
  here("static", "site_libs", "bib", "publicationsCVclean.bib"), check = FALSE)

# Set bib options
BibOptions(bib.style = "authoryear", style = "html", max.names = 10, 
